                ...
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-center">
                      <div className="subheader">New Client</div>
                    ...
                    <div className="h1 mb-3">6754</div>
                    <div className="d-flex mb-2">
                      <div>New client rate</div>
                    ...
                    <div className="progress progress-sm">
                      <div className="progress-bar bg-primary" style={{width: '44%'}} role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" aria-label="75% Complete">
                        <span className="visually-hidden">44% Complete</span>
                      </div>
                    </div>
                  </div>
                </div>
