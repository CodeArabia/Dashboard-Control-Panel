          ...
          <>
                ...
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="h1 mb-3">2093</div>
                    ...
                    <div className="progress progress-sm">
                      <div className="progress-bar bg-primary" style={{width: '20%'}} role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" aria-label="75% Complete">
